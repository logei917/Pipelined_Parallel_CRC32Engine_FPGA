%pipeline attemptation
%to simplify the design, we use 64 bit first, to try a 4-stage pipeline
%other works shall be done on vivado, to instantiate 4 module on top
...
fid = fopen('crc32_parallel_64.v', 'w');
% ____
...
fprintf(fid, 'module crc32_parallel_64 (\n');
fprintf(fid, '    input  [31:0]  crcIn,\n');
fprintf(fid, '    input  [63:0] data,\n');
...
fprintf(fid, '\nendmodule\n');
fclose(fid);
disp('Generated: crc32_parallel_64.v');